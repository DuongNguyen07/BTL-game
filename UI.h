...
public:
    ...
    UI( int boardWidth, int boardHeight) :BOARD_WIDTH(boardWidth), BOARD_HEIGHT(boardHeight)
    {
        ...
        pictures[PIC_SNAKE_VERTICAL] = loadTexture("snakevertical.png", renderer);
        pictures[PIC_SNAKE_HORIZONTAL] = loadTexture("snakehorizontal.png", renderer);
        pictures[PIC_SNAKE_HEAD] = loadTexture("snakehead.png", renderer);
    }
